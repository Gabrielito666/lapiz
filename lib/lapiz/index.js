...
/**
 * @class
 * @classdesc Principal class from Lapiz. Is to declare endpoints and utils
 * @extends {LapizConstants}
 */
const Lapiz = class extends LapizConstants
{
	...
	static isLapizContentType(contentType)
	{
		...
		if(Object.values(Lapiz.contentTypes).includes(/**@type {any}*/(mimeType)))
		{
