 ...
 * @description Constants for lapiz. Is a class just for extends
 */
const {z} = require("zod");
...
/**@constant @readonly @type {{ [K in keyof typeof resStatus]: z.ZodLiteral<typeof resStatus[K]> }}*/
const resStatusSchemas = Object.entries(resStatus).reduce((acc, [key, value]) =>
{
	//@ts-ignore
	acc[key] = z.literal(value);
	return acc;
}, /**@type {{ [K in keyof typeof resStatus]: z.ZodLiteral<typeof resStatus[K]> }}*/({}))

/**@constant @readonly @type {{ [K in keyof typeof contentTypes]: z.ZodLiteral<typeof contentTypes[K]> }}*/
const contentTypeSchemas = Object.entries(contentTypes).reduce((acc, [key, value]) =>
{
	//@ts-ignore
	acc[key] = z.literal(value);
	return acc;
}, /**@type {{ [K in keyof typeof contentTypes]: z.ZodLiteral<typeof contentTypes[K]> }}*/({}));

/**
 * @typedef {typeof contentTypes[keyof typeof contentTypes]} ContentType
 */

const LapizConstants = class
{
	static resStatus = resStatus;
	static contentTypes = contentTypes;
	static resStatusSchemas = resStatusSchemas;
	static contentTypeSchemas = contentTypeSchemas;

}

module.exports = LapizConstants;
